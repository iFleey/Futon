...
.first, kLiteRtUnrankedTensorType);
EXPECT_EQ(tensor
->

Type()

.second.unranked_tensor_type.element_type,
...
.second.ranked_tensor_type.layout.rank, 2);
EXPECT_EQ(tensor
->

Type()

.second.ranked_tensor_type.layout.dimensions[0], 3);
EXPECT_EQ(tensor
->

Type()

.second.ranked_tensor_type.layout.dimensions[1], 3);
EXPECT_EQ(tensor
->
...
.first, kLiteRtQuantizationPerTensor);
EXPECT_EQ(tensor
->

Qparams()

.second.per_tensor.scale, 1.0);
EXPECT_EQ(tensor
->

Qparams()

.second.per_tensor.zero_point, 1);
}
...
EXPECT_EQ(built_per_channel_quantization
...
Inputs(), ElementsAre(&input_tensor_0, &input_tensor_1)

);
EXPECT_THAT(op
->

Outputs(), ElementsAre(&output_tensor_0)
