...
// the function works.
LITERT_ASSERT_OK_AND_ASSIGN(LiteRtAccelerator
accelerator,
...
EXPECT_THAT(hardware_support
& kLiteRtHwAcceleratorCpu, true);
EXPECT_THAT(hardware_support
& kLiteRtHwAcceleratorGpu, false);
EXPECT_THAT(hardware_support
& kLiteRtHwAcceleratorNpu, false);
...
EXPECT_THAT(does_jit_compilation,
false);
