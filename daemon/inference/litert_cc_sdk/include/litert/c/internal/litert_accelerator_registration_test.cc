...
namespace {
    ...
    .GetName, DummyAccelerator::GetName);
}
...
EXPECT_EQ(accelerator
.GetVersion, DummyAccelerator::GetVersion);
}
...
EXPECT_EQ(accelerator
.CreateDelegate, DummyAccelerator::CreateDelegate);
EXPECT_EQ(accelerator
.DestroyDelegate, DummyAccelerator::DestroyDelegate);
}
...
LiteRtRegisterAccelerator(env_, accelerator, dummy_accelerator
.
