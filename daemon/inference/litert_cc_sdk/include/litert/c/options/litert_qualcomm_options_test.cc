...
EXPECT_EQ(number_of_ids, kDumpTensorIds
.
...
GetLogLevel(), QualcommOptions::LogLevel::kInfo

);
options->
SetLogLevel(QualcommOptions::LogLevel::kWarn);
EXPECT_EQ(options
->

GetLogLevel(), QualcommOptions::LogLevel::kWarn
...
options->
SetHtpPerformanceMode(QualcommOptions::HtpPerformanceMode::kBurst);
EXPECT_EQ(options
->
...
GetProfiling(), QualcommOptions::Profiling::kOff

);
options->
SetProfiling(QualcommOptions::Profiling::kDetailed);
EXPECT_EQ(options
->

GetProfiling(), QualcommOptions::Profiling::kDetailed
...
options->
SetDumpTensorIds(kDumpTensorIds);
...
options->
SetGraphPriority(QualcommOptions::GraphPriority::kHigh);
EXPECT_EQ(options
->

GetGraphPriority(), QualcommOptions::GraphPriority::kHigh
