...
LiteRtStatus LiteRtQualcommOptionsSetLogLevel(
        LiteRtQualcommOptions
options , LiteRtQualcommOptionsLogLevel log_level ) ;
...
LiteRtStatus LiteRtQualcommOptionsSetUseHtpPreference(
        LiteRtQualcommOptions
options , bool use_htp_preference ) ;
...
LiteRtStatus LiteRtQualcommOptionsSetUseQint16AsQuint16(
        LiteRtQualcommOptions
options , bool use_qint16_as_quint16 ) ;
...
LiteRtStatus LiteRtQualcommOptionsSetEnableWeightSharing(
        LiteRtQualcommOptions
options , bool enable_weight_sharing ) ;
...
LiteRtStatus LiteRtQualcommOptionsSetDumpTensorIds(
        LiteRtQualcommOptions
options , const int32_t *ids, uint32_t
number_of_ids ) ;

LiteRtStatus LiteRtQualcommOptionsGetDumpTensorIds(
        LiteRtQualcommOptions
options , int32_t **ids, uint32_t * number_of_ids ) ;
...
LiteRtStatus LiteRtQualcommOptionsSetUseConvHMX(LiteRtQualcommOptions
options ,
bool use_conv_hmx ) ;

LiteRtStatus LiteRtQualcommOptionsGetUseConvHMX(LiteRtQualcommOptions
options ,
bool *use_conv_hmx ) ;
...
LiteRtStatus LiteRtQualcommOptionsSetUseFoldReLU(LiteRtQualcommOptions
options ,
bool use_fold_relu ) ;

LiteRtStatus LiteRtQualcommOptionsGetUseFoldReLU(LiteRtQualcommOptions
options ,
bool *use_fold_relu ) ;
...
LiteRtStatus LiteRtQualcommOptionsSetProfiling(
        LiteRtQualcommOptions
options , LiteRtQualcommOptionsProfiling profiling ) ;

LiteRtStatus LiteRtQualcommOptionsGetProfiling(
        LiteRtQualcommOptions
options , LiteRtQualcommOptionsProfiling *profiling ) ;

LiteRtStatus LiteRtQualcommOptionsSetIrJsonDir(LiteRtQualcommOptions
options ,
const char *ir_json_dir ) ;

LiteRtStatus LiteRtQualcommOptionsGetIrJsonDir(LiteRtQualcommOptions
options ,
const char **ir_json_dir ) ;

LiteRtStatus LiteRtQualcommOptionsSetDlcDir(LiteRtQualcommOptions
options ,
const char *dlc_dir ) ;

LiteRtStatus LiteRtQualcommOptionsGetDlcDir(LiteRtQualcommOptions
options ,
const char **dlc_dir ) ;

LiteRtStatus LiteRtQualcommOptionsSetVtcmSize(LiteRtQualcommOptions
options ,
uint32_t vtcm_size ) ;

LiteRtStatus LiteRtQualcommOptionsGetVtcmSize(LiteRtQualcommOptions
options ,
uint32_t *vtcm_size ) ;

LiteRtStatus LiteRtQualcommOptionsSetNumHvxThreads(
        LiteRtQualcommOptions
options , uint32_t num_hvx_threads ) ;
