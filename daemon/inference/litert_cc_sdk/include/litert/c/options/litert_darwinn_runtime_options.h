...
LiteRtStatus LiteRtSetDarwinnInferencePowerState(
        LiteRtDarwinnRuntimeOptions
options , uint32_t power_state ) ;
...
LiteRtStatus LiteRtSetDarwinnInferenceMemoryPowerState(
        LiteRtDarwinnRuntimeOptions
options , uint32_t memory_power_state ) ;
