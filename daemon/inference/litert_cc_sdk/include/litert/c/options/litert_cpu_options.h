...
LiteRtStatus LiteRtSetCpuOptionsNumThread(LiteRtCpuOptions
options ,
int num_threads ) ;
...
LiteRtStatus LiteRtSetCpuOptionsXNNPackFlags(LiteRtCpuOptions
options ,
uint32_t flags ) ;
...
// object.
LiteRtStatus LiteRtSetCpuOptionsXnnPackWeightCachePath(LiteRtCpuOptions
options ,
const char *path ) ;
