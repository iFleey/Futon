...
namespace {
    ...
    GetDeviceType(), kLiteRtIntelOpenVinoDeviceTypeNPU
...
options_->
SetDeviceType(kLiteRtIntelOpenVinoDeviceTypeCPU);
EXPECT_EQ(options_
->

GetDeviceType(), kLiteRtIntelOpenVinoDeviceTypeCPU

);

options_->
SetDeviceType(kLiteRtIntelOpenVinoDeviceTypeGPU);
EXPECT_EQ(options_
->

GetDeviceType(), kLiteRtIntelOpenVinoDeviceTypeGPU

);

options_->
SetDeviceType(kLiteRtIntelOpenVinoDeviceTypeAUTO);
EXPECT_EQ(options_
->

GetDeviceType(), kLiteRtIntelOpenVinoDeviceTypeAUTO
...
options_->
SetPerformanceMode(kLiteRtIntelOpenVinoPerformanceModeThroughput);
EXPECT_EQ(options_
->
