...
namespace litert {
    namespace {
        ...
        EXPECT_EQ(absl::StrFormat("%v", kLiteRtElementTypeInt32),
        "i32");
        EXPECT_EQ(absl::StrFormat("%v", kLiteRtElementTypeFloat32),
        "f32");
    }
...
EXPECT_EQ(absl::StrFormat("%v", type),
"0d_i32<>");
}
...
EXPECT_EQ(absl::StrFormat("%v", kLiteRtOpCodeTflAdd),
"tfl.add");
EXPECT_EQ(absl::StrFormat("%v", kLiteRtOpCodeTflMul),
"tfl.mul");
EXPECT_EQ(absl::StrFormat("%v", kLiteRtOpCodeTflCustom),
"tfl.custom_op");
}
