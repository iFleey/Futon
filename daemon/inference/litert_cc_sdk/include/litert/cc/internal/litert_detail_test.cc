...
namespace litert {
    ...
    EXPECT_EQ(CtStr(CtStrData < 3 > {'a', 'b', 'c'})
    .
...
TEST(CTStringTest, ConcatSingle
) {
EXPECT_EQ(CtStrConcat("abc")
.
...
EXPECT_EQ(CtStrConcat("abc", "def", "ghi")
.
...
EXPECT_EQ(CtStrConcat("abc", "de", "g")
.
