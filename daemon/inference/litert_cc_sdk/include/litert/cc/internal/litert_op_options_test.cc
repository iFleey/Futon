...
namespace litert {
    namespace {
        ...
        LiteRtOpT op;
        op.
        SetOpCode(kLiteRtOpCodeShloComposite);

        tflite::StableHLOCompositeOptionsT options;
        options.
        name = kName;
        options.
        decomposition_subgraph_index = kSubgraph;
    ...
    LiteRtOpT op;
    op.
    SetOpCode(kLiteRtOpCodeShloAdd);
...
Status(), kLiteRtStatusErrorInvalidArgument
...
ASSERT_TRUE(res);
EXPECT_EQ(res
->fused_activation_function, kActivationFunctionTypeNone);
EXPECT_NE(res
->fused_activation_function, kActivationFunctionTypeRelu);
EXPECT_EQ(&op, res
->op);
}
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflBatchMatmul);
...
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_BatchMatMulOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflConcatenation);
...
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_ConcatenationOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflDiv);
tflite::DivOptionsT options;
options.
fused_activation_function = tflite::ActivationFunctionType_RELU;
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_DivOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflFullyConnected);
...
keep_num_dims = true;
options.
quantized_bias_type = tflite::TensorType_FLOAT32;
options.
...
->keep_num_dims, true);
EXPECT_EQ(res
->quantized_bias_type, kLiteRtElementTypeFloat32);
EXPECT_EQ(res
->asymmetric_quantize_input, false);
EXPECT_EQ(res
->weights_format,
...
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_MulOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
ASSERT_TRUE(res);
EXPECT_EQ(res
->fused_activation_function, kActivationFunctionTypeReluN1To1);
EXPECT_EQ(&op, res
->op);
}
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflSoftmax);
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflStridedSlice);
...
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_StridedSliceOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflSub);
tflite::SubOptionsT options;
options.
fused_activation_function = tflite::ActivationFunctionType_TANH;
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_SubOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
ASSERT_TRUE(res);
EXPECT_EQ(res
->fused_activation_function, kActivationFunctionTypeTanh);
EXPECT_EQ(&op, res
->op);
}
...
op.
SetOpCode(kLiteRtOpCodeTflReshape);

LiteRtTensorT tensor;
tensor.
SetType(MakeRankedTensorType(kLiteRtElementTypeInt32, {2, 3})
);
op.
...
tensor2.
SetType(MakeRankedTensorType(kLiteRtElementTypeInt32, {2})
);
auto &weights = tensor2.Weights();
weights.
SetBufferManager(model_t
.
...
tensor3.
SetType(MakeRankedTensorType(kLiteRtElementTypeInt32, {3, 2})
);
op.
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflSum);
tflite::ReducerOptionsT options;
options.
keep_dims = true;
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_ReducerOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflReduceMax);
tflite::ReducerOptionsT options;
options.
keep_dims = false;
internal::TflOptions tfl_options;
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflPack);
tflite::PackOptionsT options;
options.
axis = 1;
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_PackOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflGather);
...
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_GatherOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflMean);
tflite::ReducerOptionsT options;
options.
keep_dims = true;
internal::TflOptions tfl_options;
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflSplit);
tflite::SplitOptionsT options;
options.
num_splits = 3;
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_SplitOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflConv2d);
...
dilation_h_factor = 4;
options.
fused_activation_function = tflite::ActivationFunctionType_SIGN_BIT;
internal::TflOptions tfl_options;
tfl_options.
...
->dilation_h_factor, 4);
EXPECT_EQ(res
->fused_activation_function, kActivationFunctionTypeSignBit);
EXPECT_EQ(&op, res
->op);
}
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflConv3d);
...
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_Conv3DOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflAveragePool2d);
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflMaxPool2d);
tflite::Pool2DOptionsT options;
options.
padding = tflite::Padding_VALID;
options.
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflResizeBilinear);
...
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_ResizeBilinearOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflLeakyRelu);
tflite::LeakyReluOptionsT options;
options.
alpha = 0.1;
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_LeakyReluOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflSpaceToDepth);
tflite::SpaceToDepthOptionsT options;
options.
block_size = 1;
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_SpaceToDepthOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflDepthToSpace);
tflite::DepthToSpaceOptionsT options;
options.
block_size = 1;
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_DepthToSpaceOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflResizeNearestNeighbor);
...
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_ResizeNearestNeighborOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflCumsum);
...
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_CumsumOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflGelu);
tflite::GeluOptionsT options;
options.
approximate = true;
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_GeluOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
...
LiteRtOpT op;
op.
SetOpCode(kLiteRtOpCodeTflMirrorPad);
tflite::MirrorPadOptionsT options;
options.
mode = tflite::MirrorPadMode_REFLECT;
internal::TflOptions tfl_options;
tfl_options.
type = ::tflite::BuiltinOptions_MirrorPadOptions;
tfl_options.
Set(std::move(options)
);
litert::internal::SetTflOptions(op, std::move(tfl_options)
