...
namespace litert {
    ...
    Expected <TensorBuffer> CompiledModel::CreateBufferImpl(
        ...
        buffer_size, buffer_requirements.BufferSize());

        LITERT_ASSIGN_OR_RETURN(TensorBuffer
        buffer, TensorBuffer::CreateManaged(
    ...
    Expected <TensorBuffer> CompiledModel::CreateInputOutputBuffer(
        ...
        LITERT_ASSIGN_OR_RETURN(RankedTensorType
        tensor_type, tensor_type_expected);
